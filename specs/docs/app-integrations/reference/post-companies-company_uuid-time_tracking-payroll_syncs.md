...
````json
{
  ...
  "components": {
    "schemas": {
      ...
      "Payroll-Sync-Create-Request-Body": {
        "type": "object",
        "required": [
          "kind",
          "pay_schedule_uuid",
        ...
        "properties": {
          ...
          "pay_schedule_uuid": {
            "type": "string",
            "format": "uuid",
            "description": "Unique identifier of the pay schedule to sync time sheets for.",
  ...
  "paths": {
    "/v1/companies/{company_id}/time_tracking/payroll_syncs": {
      "post": {
        "summary": "Create a payroll sync",
        "parameters": [
          {
        ...
        "x-gusto-rswag": true,
        "operationId": "post-companies-company_uuid-time_tracking-payroll_syncs",
        "security": [
          {
            "CompanyAccessAuth": []
          }
        ],
        "description": "Initiate a payroll sync for a company.\n\nA payroll sync takes approved time sheet data and syncs it to the company's payroll.\n\n### Asynchronous processing\nThis endpoint triggers an asynchronous operation — the response will return immediately with a status of `pending` while the sync processes in the background.\n\n**To track completion:**\n\nSubscribe (via [POST /v1/webhook_subscriptions](https://docs.gusto.com/app-integrations/reference/post-v1-webhook-subscription)) to `PayrollSync` webhook events\n\nscope: `payroll_syncs:write`",
        "tags": [
          "Time Tracking"
        ],
            ...
            "content": {
              "application/json": {
                "examples": {
                  "pending_sync": {
                    "value": {
                      "$ref": "#/components/schemas/Payroll-Sync/x-examples/pending_sync"
                    }
                  }
                },
                "schema": {
            ...
            "content": {
              "application/json": {
                "examples": {
                  "payroll_sync_invalid_pay_schedule": {
                    "value": {
                      "$ref": "#/components/schemas/Unprocessable-Entity-Error-Object/x-examples/payroll_sync_invalid_pay_schedule"
                    }
                  },
                  "payroll_sync_no_employees": {
                    "value": {
                      "$ref": "#/components/schemas/Unprocessable-Entity-Error-Object/x-examples/payroll_sync_no_employees"
                    }
                  },
                  "payroll_sync_empty_export": {
                    "value": {
                      "$ref": "#/components/schemas/Unprocessable-Entity-Error-Object/x-examples/payroll_sync_empty_export"
                    }
                  }
                },
                "schema": {
        ...
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/Payroll-Sync-Create-Request-Body"
              }
            }
          }
        }
